...
class RegisterEmployeeeView(CreateView):
    model = User
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            user.save()
            messages.success(self.request, 'You have been successfully registered. Please log in.')
            return redirect('accounts:login')
        else:
            return render(request, 'accounts/employee/register.html', {'form': form})


class RegisterEmployeerView(CreateView):
    model = User
